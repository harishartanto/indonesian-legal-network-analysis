...
def prompt_formatting(
    ...
    if total_len > context_len:
        ...
        # Determined by cosine similarity between topic string & document embedding
            ...
            topics = [topic.split(" ")[1] for topic in topic_str.split("\n")[:-1]]
            cos_sim = compute_similarity(doc, topics)
...
def main():
    ...
    context = context_map.get(args.deployment_name, 4096)
